...
Shader "SuburbanHouse/MaskedColorChange"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature_local _ACTIVATEMASKING_ON
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 uv08 = IN.ase_texcoord7.xy * temp_cast_0 + float2( 0,0 );
				float4 tex2DNode1 = tex2D( _Basecolor, uv08 );
				float4 lerpResult6 = lerp( tex2DNode1 , _Color , tex2D( _Mask, uv08 ).r);
				#ifdef _MASKED_ON
				...
				float4 tex2DNode2 = tex2D( _MetallicSmoothness, uv08 );
				
				float3 Albedo = staticSwitch13.rgb;
				float3 Normal = UnpackNormalScale( tex2D( _Normal, uv08 ), _Normal_Strength );
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = tex2DNode2.r;
				float Smoothness = tex2DNode2.a;
				float Occlusion = tex2D( _AO, uv08 ).r;
		...
		Pass
		{
			...
			half4 ShadowPassFragment(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 temp_cast_0 = (1.0).xx;
				float2 uv08 = IN.ase_texcoord2.xy * temp_cast_0 + float2( 0,0 );
				float4 tex2DNode1 = tex2D( _Basecolor, uv08 );
...
/*ASEBEGIN
Version=18000
1934;14;1906;1005;828.312;789.815;1.3;True;True
...
WireConnection;15;4;2;4
WireConnection;15;5;10;1
WireConnection;15;6;1;4
ASEEND*/
//CHKSM=492BA72FCB42F7C1DFC932BEE923445E25EBE253